...
export function Button({ as = 'a', variant = 'primary', size = 'normal', magnetic = false, className = '', children, ...rest }) {
  const base =
    'inline-flex items-center justify-center gap-2 rounded-full font-medium transition-[transform,background-color,box-shadow,color] duration-300 ease-lux [touch-action:manipulation] hover:-translate-y-0.5'
