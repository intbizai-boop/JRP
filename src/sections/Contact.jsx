      ...
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
        <div>
          <SectionHeading
            ...
            lead="Connect directly with our Chief Travel Coordinator to outline your bespoke itinerary, secure private transport, or orchestrate elite event logistics."
          />
          <dl className="mt-10 space-y-6">
            <div>
              <dt className="font-mono text-[11px] uppercase tracking-widemono text-mute">Concierge Director</dt>
              <dd className="mt-1 text-ink font-semibold text-lg">Praveen</dd>
            </div>
            <div>
              <dt className="font-mono text-[11px] uppercase tracking-widemono text-mute">Response time</dt>
              <dd className="mt-1 text-ink">Immediate connection.</dd>
            </div>
            <div>
              <dt className="font-mono text-[11px] uppercase tracking-widemono text-mute">Coverage</dt>
              <dd className="mt-1 text-ink">India & worldwide.</dd>
            </div>
          </dl>
        </div>

        <div className="rounded-2xl bg-canvas p-8 shadow-soft md:p-10 flex flex-col justify-center border border-hairline">
          <h3 className="font-display text-2xl font-semibold text-ink">Start Your Consultation</h3>
